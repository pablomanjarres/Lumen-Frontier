        ...
        <div className="px-0.5 py-8 relative max-w-[1920px] mx-auto">
          {widgets.length === 0 ? (
            <div className="flex items-center justify-center min-h-[80vh]">
              <div className="text-center bg-surface-overlay border border-hairline rounded-card shadow-soft-lg p-12 max-w-md">
                <div className="w-24 h-24 bg-gradient-to-br from-brass-400 to-cognac-600 rounded-full flex items-center justify-center mx-auto mb-6 shadow-soft">
                  <svg className="w-12 h-12 text-surface-base" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="2.5" d="M4 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2V6zM14 6a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2V6zM4 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2H6a2 2 0 01-2-2v-2zM14 16a2 2 0 012-2h2a2 2 0 012 2v2a2 2 0 01-2 2h-2a2 2 0 01-2-2v-2z" />
                  </svg>
                </div>
                <h2 className="text-3xl font-bold text-primary mb-3">No Widgets</h2>
                <p className="text-secondary mb-6">Add widgets to get started</p>
                <button
                  onClick={() => $isMarketplaceOpen.set(true)}
                  className="bg-brass-500 hover:bg-brass-600 text-surface-base rounded-control px-8 py-3 font-semibold shadow-soft-sm transition-colors focus-visible:outline-none focus-visible:shadow-focus border border-hairline"
                >
